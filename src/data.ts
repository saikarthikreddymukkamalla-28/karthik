...
export function parseVideoUrl(url: string): { embedType: "youtube" | "instagram" | "direct"; youtubeId?: string; cleanUrl: string } {
  const cleanUrl = url.trim();
  // YouTube match (Shorts, standard watch, or shortened)
  const ytMatch = cleanUrl.match(/(?:youtube\.com\/(?:shorts\/|watch\?v=|embed\/)|youtu\.be\/)([a-zA-Z0-9_-]{11})/i);
  if (ytMatch && ytMatch[1]) {
    return { embedType: "youtube", youtubeId: ytMatch[1], cleanUrl };
  }
  // Instagram match
  if (cleanUrl.includes("instagram.com") || cleanUrl.includes("instagr.am")) {
    return { embedType: "instagram", cleanUrl };
  }
  return { embedType: "direct", cleanUrl };
}
...
export const reels: Reel[] = [
  // TECH REELS
  {
    ...
    embedType: "youtube", youtubeId: "7L_89688k98", isFunny: true
  },
  {
    ...
    embedType: "youtube", youtubeId: "m_S4u-Q82Cg"
  },
  {
    ...
    embedType: "youtube", youtubeId: "k-01P2c6HNE", isFunny: true
  },
  {
  ...
  },
  {
    ...
    embedType: "youtube", youtubeId: "shW9i6k8CB0"
  },
  {
    ...
    embedType: "youtube", youtubeId: "aircAruvnKk"
  },
  {
  ...
  },
  {
    ...
    embedType: "youtube", youtubeId: "SqcXvc3ZmRU"
  },
  {
    ...
    embedType: "youtube", youtubeId: "8JJ101D3knE"
  },
  {
  ...
  },
  {
    ...
    embedType: "youtube", youtubeId: "9yeOJ0ZMUmo"
  },
  {
  ...
  {
    id: "r19", title: "Docker Explained in 60 Seconds", creator: "@devopsdaily",
    ...
    embedType: "youtube", youtubeId: "Gjnup-Jml6U"
  },
  {
  ...
  // FUNNY TECH REELS & MEMES (INTERLEAVED IN MIDDLE)
  {
    id: "f1", title: "Senior Developer vs Junior Developer in Code Review", creator: "@techhumor",
    category: "Funny", topics: ["Developer Culture", "Programming", "Humor"], relatedTopics: ["Software Engineering"],
    context: "Funny developer meme", difficulty: "Beginner", technicalDepth: 10, educationalValue: 20,
    careerRelevance: 40, entertainmentValue: 98, hypeScore: 5, duration: 25,
    description: "When the junior developer submits a 5,000 line pull request right before Friday deployment.",
    gradient: "linear-gradient(135deg,#833ab4,#fd1d1d,#fcb045)",
    embedType: "youtube", youtubeId: "J---aiyznGQ", isFunny: true
  },
  {
    id: "f2", title: "Debugging Code at 3 AM Be Like...", creator: "@devmemes",
    category: "Funny", topics: ["Debugging", "Programming", "Developer Life"], relatedTopics: ["Software Engineering"],
    context: "Funny programming short", difficulty: "Beginner", technicalDepth: 15, educationalValue: 25,
    careerRelevance: 35, entertainmentValue: 96, hypeScore: 5, duration: 20,
    description: "Fixing a missing semicolon after 4 hours of intense scientific existential dread.",
    gradient: "linear-gradient(135deg,#11998e,#38ef7d)",
    embedType: "youtube", youtubeId: "F1W27d2E4Q0", isFunny: true
  },
  {
    id: "f3", title: "Trying to Center a Div in CSS", creator: "@csslol",
    category: "Funny", topics: ["CSS", "Web Development", "Humor"], relatedTopics: ["Frontend"],
    context: "Frontend meme short", difficulty: "Beginner", technicalDepth: 12, educationalValue: 30,
    careerRelevance: 30, entertainmentValue: 95, hypeScore: 6, duration: 18,
    description: "margin: auto; display: flex; align-items: center; justify-content: center; still floating in space.",
    gradient: "linear-gradient(135deg,#ff4b1f,#ff9068)",
    embedType: "youtube", youtubeId: "QHaz36l0174", isFunny: true
  },
  {
    id: "f4", title: "When Production Server Crashes During Demo", creator: "@devopsfails",
    category: "Funny", topics: ["DevOps", "Production", "Developer Humor"], relatedTopics: ["Cloud"],
    context: "Funny tech incident meme", difficulty: "Beginner", technicalDepth: 14, educationalValue: 22,
    careerRelevance: 45, entertainmentValue: 97, hypeScore: 8, duration: 24,
    description: "The CEO asks to present live and localhost refuses to connect.",
    gradient: "linear-gradient(135deg,#eecda3,#ef629f)",
    embedType: "instagram", sourceUrl: "https://www.instagram.com/reel/C1234567890", isFunny: true
  }
];

export const defaultInterests: Record<string, number> = {
  "Software Engineering": 18, AI: 18, DSA: 18, Java: 18,
  Hardware: 16, Cloud: 12, Cybersecurity: 10, "System Design": 8, Funny: 14
};
